...
import org.teavm.classlib.sun.security.action.TGetPropertyAction;
 ...
 */
public class TDebug {
    private TString prefix;
    private static TString args = (TString) TAccessController.doPrivileged(new GetPropertyAction("java.security.debug"));
    ...
    public static org.teavm.classlib.sun.security.util.TDebug getInstance(TString var0) {
        return getInstance(var0, var0);
    }

    public static org.teavm.classlib.sun.security.util.TDebug getInstance(TString var0, TString var1) {
        if(isOn(var0)) {
            org.teavm.classlib.sun.security.util.TDebug var2 = new org.teavm.classlib.sun.security.util.TDebug();
            var2.prefix = var1;
            return var2;
        } else {
            return null;
    ...
    public static boolean isOn(TString var0) {
        return args == null?false:(args.indexOf(TString.wrap("all")) != -1?true:args.indexOf(var0) != -1);
    }
    ...
    static {
        TString var0 = (TString)TAccessController.doPrivileged(new TGetPropertyAction("java.security.auth.debug"));
        if(args == null) {
            args = var0;
        } else if(var0 != null) {
            args = args + "," + var0;
