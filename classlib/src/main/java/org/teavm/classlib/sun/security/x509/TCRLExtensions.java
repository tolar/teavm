...
public class TCRLExtensions {
    ...
    private static final TClass[] PARAMS = new TClass[]{TBoolean.class, TObject.class};

    public TCRLExtensions() {
    }

    public TCRLExtensions(TDerInputStream var1) throws CRLException {
        this.init(var1);
    }

    private void init(TDerInputStream var1) throws CRLException {
        try {
    ...
    private void parseExtension(TExtension var1) throws CRLException {
        try {
    ...
    public void encode(TOutputStream var1, boolean var2) throws CRLException {
        try {
