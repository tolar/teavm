 ...
 */
class TUnsafeShortFieldAccessorImpl extends TUnsafeFieldAccessorImpl {
    TUnsafeShortFieldAccessorImpl(TField var1) {
        super(var1);
    }
    ...
    public short getShort(Object var1) throws IllegalArgumentException {
        this.ensureObj(var1);
        return T_UNSAFE.getShort(var1, this.fieldOffset);
    }
    ...
    public void set(Object var1, Object var2) throws IllegalArgumentException, IllegalAccessException {
        ...
        if(var2 instanceof Byte) {
            T_UNSAFE.putShort(var1, this.fieldOffset, (short)((Byte)var2).byteValue());
        } else if(var2 instanceof Short) {
            T_UNSAFE.putShort(var1, this.fieldOffset, ((Short)var2).shortValue());
        } else {
            this.throwSetIllegalArgumentException(var2);
        }
    }
    ...
    public void setShort(Object var1, short var2) throws IllegalArgumentException, IllegalAccessException {
        ...
        T_UNSAFE.putShort(var1, this.fieldOffset, var2);
    }
