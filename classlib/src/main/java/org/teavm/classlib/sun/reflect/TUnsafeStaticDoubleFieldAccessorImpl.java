 ...
 */
class TUnsafeStaticDoubleFieldAccessorImpl extends TUnsafeStaticFieldAccessorImpl {
    TUnsafeStaticDoubleFieldAccessorImpl(TField var1) {
        super(var1);
    }
    ...
    public double getDouble(Object var1) throws IllegalArgumentException {
        return T_UNSAFE.getDouble(this.base, this.fieldOffset);
    }
    ...
    public void set(Object var1, Object var2) throws IllegalArgumentException, IllegalAccessException {
        ...
        if(var2 instanceof Byte) {
            T_UNSAFE.putDouble(this.base, this.fieldOffset, (double)((Byte)var2).byteValue());
        } else if(var2 instanceof Short) {
            T_UNSAFE.putDouble(this.base, this.fieldOffset, (double)((Short)var2).shortValue());
        } else if(var2 instanceof Character) {
            T_UNSAFE.putDouble(this.base, this.fieldOffset, (double)((Character)var2).charValue());
        } else if(var2 instanceof Integer) {
            T_UNSAFE.putDouble(this.base, this.fieldOffset, (double)((Integer)var2).intValue());
        } else if(var2 instanceof Long) {
            T_UNSAFE.putDouble(this.base, this.fieldOffset, (double)((Long)var2).longValue());
        } else if(var2 instanceof Float) {
            T_UNSAFE.putDouble(this.base, this.fieldOffset, (double)((Float)var2).floatValue());
        } else if(var2 instanceof Double) {
            T_UNSAFE.putDouble(this.base, this.fieldOffset, ((Double)var2).doubleValue());
        } else {
            this.throwSetIllegalArgumentException(var2);
        }
    }
    ...
    public void setDouble(Object var1, double var2) throws IllegalArgumentException, IllegalAccessException {
        ...
        T_UNSAFE.putDouble(this.base, this.fieldOffset, var2);
    }
}
