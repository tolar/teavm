...
public abstract class TBaseCalendar extends TAbstractCalendar {
        ...
        if(var2.isNormalized()) {
            ...
            if(var3 >= 1 && var3 <= 12) {
                ...
                if(var4 > 0 && var4 <= this.getMonthLength(var2.getNormalizedYear(), var3)) {
                    ...
                    if(var5 != -2147483648 && var5 != this.getDayOfWeek(var2)) {
                        return false;
    ...
    public long getFixedDate(CalendarDate var1) {
        ...
        return this.getFixedDate(((TBaseCalendar.Date)var1).getNormalizedYear(), var1.getMonth(), var1.getDayOfMonth(), (TBaseCalendar.Date)var1);
    }

    public long getFixedDate(int var1, int var2, int var3, TBaseCalendar.Date var4) {
        ...
        if(var4 != null && var4.hit(var1)) {
            ...
            if(var6 >= 0 && var6 < FIXED_DATES.length) {
                ...
                if(var7 >= 0L) {
                    ...
                    var9 += 365L * var7 + TCalendarUtils.floorDivide(var7, 4L) - TCalendarUtils.floorDivide(var7, 100L) + TCalendarUtils
                            .floorDivide(var7, 400L) + (long) TCalendarUtils.floorDivide(367 * var2 - 362, 12);
                }
    ...
    public void getCalendarDateFromFixedDate(CalendarDate var1, long var2) {
        ...
        if(var4.hit(var2)) {
            ...
            var6 = this.getFixedDate(var5, 1, 1, (TBaseCalendar.Date)null);
            var8 = this.isLeapYear(var5);
        ...
        if(var12 > 0) {
            ...
            var12 = TCalendarUtils.floorDivide(var12, 367);
        }
    ...
    public static final int getDayOfWeekFromFixedDate(long var0) {
        return var0 >= 0L?(int)(var0 % 7L) + 1:(int) TCalendarUtils.mod(var0, 7L) + 1;
    }
    ...
    final int getGregorianYearFromFixedDate(long var1) {
        ...
        if(var1 > 0L) {
            ...
            var3 = var1 - 1L;
            var9 = (int) TCalendarUtils.floorDivide(var3, 146097L);
            var5 = (int) TCalendarUtils.mod(var3, 146097L);
            var10 = TCalendarUtils.floorDivide(var5, '躬');
            var6 = TCalendarUtils.mod(var5, '躬');
            var11 = TCalendarUtils.floorDivide(var6, 1461);
            var7 = TCalendarUtils.mod(var6, 1461);
            var12 = TCalendarUtils.floorDivide(var7, 365);
            var8 = TCalendarUtils.mod(var7, 365) + 1;
        }
    ...
    public abstract static class Date extends CalendarDate {
        ...
        public TBaseCalendar.Date setNormalizedDate(int var1, int var2, int var3) {
