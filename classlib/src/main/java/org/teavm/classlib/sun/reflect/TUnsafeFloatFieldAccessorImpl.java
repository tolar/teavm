 ...
 */
class TUnsafeFloatFieldAccessorImpl extends TUnsafeFieldAccessorImpl {
    TUnsafeFloatFieldAccessorImpl(TField var1) {
        super(var1);
    }
    ...
    public float getFloat(Object var1) throws IllegalArgumentException {
        this.ensureObj(var1);
        return T_UNSAFE.getFloat(var1, this.fieldOffset);
    }
    ...
    public void set(Object var1, Object var2) throws IllegalArgumentException, IllegalAccessException {
        ...
        if(var2 instanceof Byte) {
            T_UNSAFE.putFloat(var1, this.fieldOffset, (float)((Byte)var2).byteValue());
        } else if(var2 instanceof Short) {
            T_UNSAFE.putFloat(var1, this.fieldOffset, (float)((Short)var2).shortValue());
        } else if(var2 instanceof Character) {
            T_UNSAFE.putFloat(var1, this.fieldOffset, (float)((Character)var2).charValue());
        } else if(var2 instanceof Integer) {
            T_UNSAFE.putFloat(var1, this.fieldOffset, (float)((Integer)var2).intValue());
        } else if(var2 instanceof Long) {
            T_UNSAFE.putFloat(var1, this.fieldOffset, (float)((Long)var2).longValue());
        } else if(var2 instanceof Float) {
            T_UNSAFE.putFloat(var1, this.fieldOffset, ((Float)var2).floatValue());
        } else {
            this.throwSetIllegalArgumentException(var2);
        }
    }
    ...
    public void setFloat(Object var1, float var2) throws IllegalArgumentException, IllegalAccessException {
        ...
        T_UNSAFE.putFloat(var1, this.fieldOffset, var2);
    }
