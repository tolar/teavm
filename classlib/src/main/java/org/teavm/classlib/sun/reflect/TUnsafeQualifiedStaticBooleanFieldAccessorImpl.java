 ...
 */
class TUnsafeQualifiedStaticBooleanFieldAccessorImpl extends TUnsafeQualifiedStaticFieldAccessorImpl {
    TUnsafeQualifiedStaticBooleanFieldAccessorImpl(TField var1, boolean var2) {
        super(var1, var2);
    }
    ...
    public boolean getBoolean(Object var1) throws IllegalArgumentException {
        return T_UNSAFE.getBooleanVolatile(this.base, this.fieldOffset);
    }
    ...
    public void set(Object var1, Object var2) throws IllegalArgumentException, IllegalAccessException {
        ...
        if(var2 instanceof Boolean) {
            T_UNSAFE.putBooleanVolatile(this.base, this.fieldOffset, ((Boolean)var2).booleanValue());
        } else {
            this.throwSetIllegalArgumentException(var2);
        }
    }
    ...
    public void setBoolean(Object var1, boolean var2) throws IllegalArgumentException, IllegalAccessException {
        ...
        T_UNSAFE.putBooleanVolatile(this.base, this.fieldOffset, var2);
    }
