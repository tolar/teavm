...
public class TBitArray {
    ...
    public TBitArray(int var1) throws IllegalArgumentException {
        if(var1 < 0) {
    ...
    public TBitArray(int var1, byte[] var2) throws IllegalArgumentException {
        if(var1 < 0) {
            throw new IllegalArgumentException("Negative length for BitArray");
            ...
            if(var3 > 0) {
                this.repn[var3 - 1] &= var5;
            }

        }
    }

    public TBitArray(boolean[] var1) {
    ...
    private TBitArray(TBitArray var1) {
        this.length = var1.length;
    ...
    public void set(int var1, boolean var2) throws ArrayIndexOutOfBoundsException {
        if(var1 >= 0 && var1 < this.length) {
            ...
            if(var2) {
                this.repn[var3] = (byte)(this.repn[var3] | var4);
            } else {
                this.repn[var3] = (byte)(this.repn[var3] & ~var4);
            }
    ...
    public String toString() {
        TByteArrayOutputStream var1 = new TByteArrayOutputStream();
    ...
    public TBitArray truncate() {
        for(int var1 = this.length - 1; var1 >= 0; --var1) {
            if(this.get(var1)) {
                return new TBitArray(var1 + 1, TArrays.copyOf(this.repn, (var1 + 8) / 8));
            }
        }
