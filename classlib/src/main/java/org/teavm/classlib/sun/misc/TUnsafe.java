...
public final class TUnsafe {
    private static final TUnsafe THE_T_UNSAFE;
    ...
    static {
        ...
        ARRAY_SHORT_BASE_OFFSET = THE_T_UNSAFE.arrayBaseOffset(short[].class);
        ARRAY_CHAR_BASE_OFFSET = THE_T_UNSAFE.arrayBaseOffset(char[].class);
        ARRAY_INT_BASE_OFFSET = THE_T_UNSAFE.arrayBaseOffset(int[].class);
        ARRAY_LONG_BASE_OFFSET = THE_T_UNSAFE.arrayBaseOffset(long[].class);
        ARRAY_FLOAT_BASE_OFFSET = THE_T_UNSAFE.arrayBaseOffset(float[].class);
        ARRAY_DOUBLE_BASE_OFFSET = THE_T_UNSAFE.arrayBaseOffset(double[].class);
        ARRAY_OBJECT_BASE_OFFSET = THE_T_UNSAFE.arrayBaseOffset(Object[].class);
        ARRAY_BOOLEAN_INDEX_SCALE = THE_T_UNSAFE.arrayIndexScale(boolean[].class);
        ARRAY_BYTE_INDEX_SCALE = THE_T_UNSAFE.arrayIndexScale(byte[].class);
        ARRAY_SHORT_INDEX_SCALE = THE_T_UNSAFE.arrayIndexScale(short[].class);
        ARRAY_CHAR_INDEX_SCALE = THE_T_UNSAFE.arrayIndexScale(char[].class);
        ARRAY_INT_INDEX_SCALE = THE_T_UNSAFE.arrayIndexScale(int[].class);
        ARRAY_LONG_INDEX_SCALE = THE_T_UNSAFE.arrayIndexScale(long[].class);
        ARRAY_FLOAT_INDEX_SCALE = THE_T_UNSAFE.arrayIndexScale(float[].class);
        ARRAY_DOUBLE_INDEX_SCALE = THE_T_UNSAFE.arrayIndexScale(double[].class);
        ARRAY_OBJECT_INDEX_SCALE = THE_T_UNSAFE.arrayIndexScale(Object[].class);
        ADDRESS_SIZE = THE_T_UNSAFE.addressSize();
    }
}
