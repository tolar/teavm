...
public class TGetInstance {
    ...
    public static TProvider.Service getService(TString var0, TString var1, TString var2) throws TNoSuchAlgorithmException,
        ...
        if(var2 != null && var2.length() != 0) {
            ...
            if(var3 == null) {
                ...
                if(var4 == null) {
                    throw new TNoSuchAlgorithmException(TString.wrap("no such algorithm: " + var1 + " for provider " + var2));
                } else {
                    return var4;
                }
            }
    ...
    public static TProvider.Service getService(TString var0, TString var1, TProvider var2) throws TNoSuchAlgorithmException {
        if(var2 == null) {
            throw new IllegalArgumentException("missing provider");
        } else {
            TProvider.Service var3 = var2.getService(var0, var1);
            if(var3 == null) {
                throw new TNoSuchAlgorithmException(TString.wrap("no such algorithm: " + var1 + " for provider " + var2.getName()));
            } else {
                return var3;
            }
        }
    ...
    /** @deprecated */
    @Deprecated
    public static TList<TProvider.Service> getServices(TString var0, TList<TString> var1) {
        TProviderList var2 = TProviders.getProviderList();
        return var2.getServices(var0, var1);
    }

    public static TList<TProvider.Service> getServices(TList<TServiceId> var0) {
        TProviderList var1 = TProviders.getProviderList();
        return var1.getServices(var0);
    }

    public static TGetInstance.Instance getInstance(TString var0, TClass<?> var1, TString var2) throws TNoSuchAlgorithmException {
        TProviderList var3 = TProviders.getProviderList();
        TProvider.Service var4 = var3.getService(var0, var2);
        if(var4 == null) {
            throw new TNoSuchAlgorithmException(TString.wrap(var2 + " " + var0 + " not available"));
        } else {
            try {
                return getInstance(var4, var1);
            } catch (TNoSuchAlgorithmException var10) {
                TNoSuchAlgorithmException var5 = var10;
                Iterator var6 = var3.getServices(var0, var2).iterator();

                while(true) {
                    TProvider.Service var7;
                    do {
                        if(!var6.hasNext()) {
                            throw var5;
                        }

                        var7 = (TProvider.Service)var6.next();
                    } while(var7 == var4);
    ...
    public static TGetInstance.Instance getInstance(TString var0, TClass<?> var1, TString var2, TObject var3) throws TNoSuchAlgorithmException {
        TList var4 = getServices(var0, var2);
        TNoSuchAlgorithmException var5 = null;
        TIterator var6 = var4.iterator();

        while(var6.hasNext()) {
            TProvider.Service var7 = (TProvider.Service)var6.next();
