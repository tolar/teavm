...
class TUnsafeStaticLongFieldAccessorImpl extends TUnsafeStaticFieldAccessorImpl {
    ...
    public long getLong(Object var1) throws IllegalArgumentException {
        return T_UNSAFE.getLong(this.base, this.fieldOffset);
    }
    ...
    public void set(Object var1, Object var2) throws IllegalArgumentException, IllegalAccessException {
        ...
        if(var2 instanceof Byte) {
            T_UNSAFE.putLong(this.base, this.fieldOffset, (long)((Byte)var2).byteValue());
        } else if(var2 instanceof Short) {
            T_UNSAFE.putLong(this.base, this.fieldOffset, (long)((Short)var2).shortValue());
        } else if(var2 instanceof Character) {
            T_UNSAFE.putLong(this.base, this.fieldOffset, (long)((Character)var2).charValue());
        } else if(var2 instanceof Integer) {
            T_UNSAFE.putLong(this.base, this.fieldOffset, (long)((Integer)var2).intValue());
        } else if(var2 instanceof Long) {
            T_UNSAFE.putLong(this.base, this.fieldOffset, ((Long)var2).longValue());
        } else {
            this.throwSetIllegalArgumentException(var2);
        }
    }
    ...
    public void setLong(Object var1, long var2) throws IllegalArgumentException, IllegalAccessException {
        ...
        T_UNSAFE.putLong(this.base, this.fieldOffset, var2);
    }
