 ...
 */
class TUnsafeQualifiedStaticIntegerFieldAccessorImpl extends TUnsafeQualifiedStaticFieldAccessorImpl {
    TUnsafeQualifiedStaticIntegerFieldAccessorImpl(TField var1, boolean var2) {
        super(var1, var2);
    }
    ...
    public int getInt(Object var1) throws IllegalArgumentException {
        return T_UNSAFE.getIntVolatile(this.base, this.fieldOffset);
    }
    ...
    public void set(Object var1, Object var2) throws IllegalArgumentException, IllegalAccessException {
        ...
        if(var2 instanceof Byte) {
            T_UNSAFE.putIntVolatile(this.base, this.fieldOffset, ((Byte)var2).byteValue());
        } else if(var2 instanceof Short) {
            T_UNSAFE.putIntVolatile(this.base, this.fieldOffset, ((Short)var2).shortValue());
        } else if(var2 instanceof Character) {
            T_UNSAFE.putIntVolatile(this.base, this.fieldOffset, ((Character)var2).charValue());
        } else if(var2 instanceof Integer) {
            T_UNSAFE.putIntVolatile(this.base, this.fieldOffset, ((Integer)var2).intValue());
        } else {
            this.throwSetIllegalArgumentException(var2);
        }
    }
    ...
    public void setInt(Object var1, int var2) throws IllegalArgumentException, IllegalAccessException {
        ...
        T_UNSAFE.putIntVolatile(this.base, this.fieldOffset, var2);
    }
