 ...
 */
class TUnsafeQualifiedStaticShortFieldAccessorImpl extends TUnsafeQualifiedStaticFieldAccessorImpl {
    TUnsafeQualifiedStaticShortFieldAccessorImpl(TField var1, boolean var2) {
        super(var1, var2);
    }
    ...
    public short getShort(Object var1) throws IllegalArgumentException {
        return T_UNSAFE.getShortVolatile(this.base, this.fieldOffset);
    }
    ...
    public void set(Object var1, Object var2) throws IllegalArgumentException, IllegalAccessException {
        ...
        if(var2 instanceof Byte) {
            T_UNSAFE.putShortVolatile(this.base, this.fieldOffset, (short)((Byte)var2).byteValue());
        } else if(var2 instanceof Short) {
            T_UNSAFE.putShortVolatile(this.base, this.fieldOffset, ((Short)var2).shortValue());
        } else {
            this.throwSetIllegalArgumentException(var2);
        }
    }
    ...
    public void setShort(Object var1, short var2) throws IllegalArgumentException, IllegalAccessException {
        ...
        T_UNSAFE.putShortVolatile(this.base, this.fieldOffset, var2);
    }
