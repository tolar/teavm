...
public class TCRLNumberExtension extends TExtension implements TCertAttrSet<String> {
    ...
    public TCRLNumberExtension(int var1) throws TIOException {
        this(TPKIXExtensions.CRLNumber_Id, false, BigInteger.valueOf((long)var1), "CRLNumber", "CRL Number");
    }

    public TCRLNumberExtension(BigInteger var1) throws TIOException {
    ...
    protected TCRLNumberExtension(TObjectIdentifier var1, Boolean var2, Object var3, String var4, String var5) throws TIOException {
        this.crlNumber = null;
        this.extensionId = var1;
    ...
    public void set(TString var1, Object var2) throws TIOException {
        if(var1.equalsIgnoreCase(TString.wrap("value"))) {
            if(!(var2 instanceof TBigInteger)) {
    ...
    protected void encode(TOutputStream var1, TObjectIdentifier var2, boolean var3) throws TIOException {
