...
public final class TObjectIdentifier implements Serializable {
    ...
    private void readObject(ObjectInputStream var1) throws IOException, ClassNotFoundException {
        ...
        if(this.encoding == null) {
            this.init((int[])((int[])this.components), this.componentLen);
        }
    ...
    private void writeObject(ObjectOutputStream var1) throws IOException {
        if(!this.componentsCalculated) {
            ...
            if(var2 != null) {
                ...
                this.components = TObjectIdentifier.HugeOidNotSupportedByOldJDK.theOne;
            }
    ...
    public TObjectIdentifier(int[] var1) throws IOException {
    ...
    public static TObjectIdentifier newInternal(int[] var0) {
        try {
            ...
            for(int var5 = 0; var5 < var2; ++var5) {
                if((this.encoding[var5] & 128) == 0) {
                    ...
                    if(var5 - var4 + 1 > 4) {
                        ...
                        if(var4 == 0) {
                            var3.append("2.");
                            var3.append(var6.subtract(BigInteger.valueOf(80L)));
                        } else {
                            var3.append(var6);
                        }
                    } else {
    ...
    private static byte[] pack(byte[] var0, int var1, int var2, int var3, int var4) {
        ...
        if(var4 > 0 && var4 <= 8) {
            ...
            throw new AssertionError("output NUB must be between 1 and 8");
        }
    }
    ...
    static class HugeOidNotSupportedByOldJDK implements Serializable {
        ...
        static TObjectIdentifier.HugeOidNotSupportedByOldJDK theOne = new TObjectIdentifier.HugeOidNotSupportedByOldJDK();
