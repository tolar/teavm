 ...
 */
class TUnsafeQualifiedStaticByteFieldAccessorImpl extends TUnsafeQualifiedStaticFieldAccessorImpl {
    TUnsafeQualifiedStaticByteFieldAccessorImpl(TField var1, boolean var2) {
        super(var1, var2);
    }
    ...
    public byte getByte(Object var1) throws IllegalArgumentException {
        return T_UNSAFE.getByteVolatile(this.base, this.fieldOffset);
    }
    ...
    public void set(Object var1, Object var2) throws IllegalArgumentException, IllegalAccessException {
        ...
        if(var2 instanceof Byte) {
            T_UNSAFE.putByteVolatile(this.base, this.fieldOffset, ((Byte)var2).byteValue());
        } else {
            this.throwSetIllegalArgumentException(var2);
        }
    }
    ...
    public void setByte(Object var1, byte var2) throws IllegalArgumentException, IllegalAccessException {
        ...
        T_UNSAFE.putByteVolatile(this.base, this.fieldOffset, var2);
    }
