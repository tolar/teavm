 ...
 */
class TUnsafeQualifiedBooleanFieldAccessorImpl extends TUnsafeQualifiedFieldAccessorImpl {
    TUnsafeQualifiedBooleanFieldAccessorImpl(TField var1, boolean var2) {
        super(var1, var2);
    }
    ...
    public boolean getBoolean(Object var1) throws IllegalArgumentException {
        this.ensureObj(var1);
        return T_UNSAFE.getBooleanVolatile(var1, this.fieldOffset);
    }
    ...
    public void set(Object var1, Object var2) throws IllegalArgumentException, IllegalAccessException {
        ...
        if(var2 instanceof Boolean) {
            T_UNSAFE.putBooleanVolatile(var1, this.fieldOffset, ((Boolean)var2).booleanValue());
        } else {
            this.throwSetIllegalArgumentException(var2);
        }
    }
    ...
    public void setBoolean(Object var1, boolean var2) throws IllegalArgumentException, IllegalAccessException {
        ...
        T_UNSAFE.putBooleanVolatile(var1, this.fieldOffset, var2);
    }
