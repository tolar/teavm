 ...
 */
class TUnsafeQualifiedStaticCharacterFieldAccessorImpl extends TUnsafeQualifiedStaticFieldAccessorImpl {
    TUnsafeQualifiedStaticCharacterFieldAccessorImpl(TField var1, boolean var2) {
        super(var1, var2);
    }
    ...
    public char getChar(Object var1) throws IllegalArgumentException {
        return T_UNSAFE.getCharVolatile(this.base, this.fieldOffset);
    }
    ...
    public void set(Object var1, Object var2) throws IllegalArgumentException, IllegalAccessException {
        ...
        if(var2 instanceof Character) {
            T_UNSAFE.putCharVolatile(this.base, this.fieldOffset, ((Character)var2).charValue());
        } else {
            this.throwSetIllegalArgumentException(var2);
        }
    }
    ...
    public void setChar(Object var1, char var2) throws IllegalArgumentException, IllegalAccessException {
        ...
        T_UNSAFE.putCharVolatile(this.base, this.fieldOffset, var2);
    }
