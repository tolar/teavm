...
public class TConditionalSpecialCasing {
    ...
    static TConditionalSpecialCasing.Entry[] entry = {
            //# ================================================================================
            //# Conditional mappings
            //# ================================================================================
            new TConditionalSpecialCasing.Entry(0x03A3, new char[]{0x03C2}, new char[]{0x03A3}, null, FINAL_CASED), // # GREEK CAPITAL LETTER SIGMA
            new TConditionalSpecialCasing.Entry(0x0130, new char[]{0x0069, 0x0307}, new char[]{0x0130}, null, 0), // # LATIN CAPITAL LETTER I WITH DOT ABOVE

            //# ================================================================================
            //# Locale-sensitive mappings
            //# ================================================================================
            //# Lithuanian
            new TConditionalSpecialCasing.Entry(0x0307, new char[]{0x0307}, new char[]{}, "lt",  AFTER_SOFT_DOTTED), // # COMBINING DOT ABOVE
            new TConditionalSpecialCasing.Entry(0x0049, new char[]{0x0069, 0x0307}, new char[]{0x0049}, "lt", MORE_ABOVE), // # LATIN CAPITAL LETTER I
            new TConditionalSpecialCasing.Entry(0x004A, new char[]{0x006A, 0x0307}, new char[]{0x004A}, "lt", MORE_ABOVE), // # LATIN CAPITAL LETTER J
            new TConditionalSpecialCasing.Entry(0x012E, new char[]{0x012F, 0x0307}, new char[]{0x012E}, "lt", MORE_ABOVE), // # LATIN CAPITAL LETTER I WITH OGONEK
            new TConditionalSpecialCasing.Entry(0x00CC, new char[]{0x0069, 0x0307, 0x0300}, new char[]{0x00CC}, "lt", 0), // # LATIN CAPITAL LETTER I WITH GRAVE
            new TConditionalSpecialCasing.Entry(0x00CD, new char[]{0x0069, 0x0307, 0x0301}, new char[]{0x00CD}, "lt", 0), // # LATIN CAPITAL LETTER I WITH ACUTE
            new TConditionalSpecialCasing.Entry(0x0128, new char[]{0x0069, 0x0307, 0x0303}, new char[]{0x0128}, "lt", 0), // # LATIN CAPITAL LETTER I WITH TILDE

            //# ================================================================================
            //# Turkish and Azeri
            new TConditionalSpecialCasing.Entry(0x0130, new char[]{0x0069}, new char[]{0x0130}, "tr", 0), // # LATIN CAPITAL LETTER I WITH DOT ABOVE
            new TConditionalSpecialCasing.Entry(0x0130, new char[]{0x0069}, new char[]{0x0130}, "az", 0), // # LATIN CAPITAL LETTER I WITH DOT ABOVE
            new TConditionalSpecialCasing.Entry(0x0307, new char[]{}, new char[]{0x0307}, "tr", AFTER_I), // # COMBINING DOT ABOVE
            new TConditionalSpecialCasing.Entry(0x0307, new char[]{}, new char[]{0x0307}, "az", AFTER_I), // # COMBINING DOT ABOVE
            new TConditionalSpecialCasing.Entry(0x0049, new char[]{0x0131}, new char[]{0x0049}, "tr", NOT_BEFORE_DOT), // # LATIN CAPITAL LETTER I
            new TConditionalSpecialCasing.Entry(0x0049, new char[]{0x0131}, new char[]{0x0049}, "az", NOT_BEFORE_DOT), // # LATIN CAPITAL LETTER I
            new TConditionalSpecialCasing.Entry(0x0069, new char[]{0x0069}, new char[]{0x0130}, "tr", 0), // # LATIN SMALL LETTER I
            new TConditionalSpecialCasing.Entry(0x0069, new char[]{0x0069}, new char[]{0x0130}, "az", 0)  // # LATIN SMALL LETTER I
    };

    // A hash table that contains the above entries
    static Hashtable<Integer, HashSet<TConditionalSpecialCasing.Entry>> entryTable = new Hashtable<>();
    static {
        // create hashtable from the entry
        for (int i = 0; i < entry.length; i ++) {
            TConditionalSpecialCasing.Entry cur = entry[i];
            Integer cp = new Integer(cur.getCodePoint());
            HashSet<TConditionalSpecialCasing.Entry> set = entryTable.get(cp);
            if (set == null) {
                set = new HashSet<TConditionalSpecialCasing.Entry>();
            }
            set.add(cur);
    ...
    private static char[] lookUpTable(TString src, int index, Locale locale, boolean bLowerCasing) {
        HashSet<TConditionalSpecialCasing.Entry> set = entryTable.get(new Integer(src.codePointAt(index)));
        char[] ret = null;

        if (set != null) {
            Iterator<TConditionalSpecialCasing.Entry> iter = set.iterator();
            String currentLang = locale.getLanguage();
            while (iter.hasNext()) {
                TConditionalSpecialCasing.Entry entry = iter.next();
    ...
    private static boolean isFinalCased(TString src, int index, Locale locale) {
        BreakIterator wordBoundary = BreakIterator.getWordInstance(locale);
        wordBoundary.setText(src.toString());
        int ch;
    ...
    private static boolean isConditionMet(TString src, int index, Locale locale, int condition) {
        switch (condition) {
            case FINAL_CASED:
     ...
     */
    private static boolean isAfterI(TString src, int index) {
        int ch;
        int cc;
     ...
     */
    private static boolean isAfterSoftDotted(TString src, int index) {
        int ch;
        int cc;
     ...
     *   After C: [{cc!=0}]*[{cc==230}]
     */
    private static boolean isMoreAbove(TString src, int index) {
        int ch;
        int cc;
        int len = src.length();
     ...
     */
    private static boolean isBeforeDot(TString src, int index) {
        int ch;
        int cc;
        int len = src.length();
    ...
    static int toLowerCaseEx(TString src, int index, Locale locale) {
        ...
        if (result != null) {
            if (result.length == 1) {
                ...
                return TCharacter.ERROR;
            }
        } else {
            // default to Character class' one
            return TCharacter.toLowerCase(src.codePointAt(index));
        }
    }


    static char[] toLowerCaseCharArray(TString src, int index, Locale locale) {
