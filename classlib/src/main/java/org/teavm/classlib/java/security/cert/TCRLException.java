...
public class TCRLException extends TGeneralSecurityException {
    ...
    /**
     * Constructs a TCRLException with no detail message. A
    ...
    /**
     * Constructs a TCRLException with the specified detail
    ...
    /**
     * Creates a {@code TCRLException} with the specified
    ...
    /**
     * Creates a {@code TCRLException} with the specified cause
