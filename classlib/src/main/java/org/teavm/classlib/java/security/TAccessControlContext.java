...
public final class TAccessControlContext {
     ...
     */
    public TAccessControlContext(ProtectionDomain context[])
    {
        if (context.length == 0) {
            this.context = null;
     ...
     * @since 1.3
     */
    public TAccessControlContext(java.security.AccessControlContext acc,
     ...
     * permission
     */
    TAccessControlContext(java.security.AccessControlContext acc,
            DomainCombiner combiner,
     ...
     */
    TAccessControlContext(ProtectionDomain caller, DomainCombiner combiner,
    ...
    TAccessControlContext(ProtectionDomain context[],
     ...
     */
    TAccessControlContext(ProtectionDomain[] context,
            java.security.TAccessControlContext privilegedContext)
    {
        this.context = context;
    ...
    DomainCombiner getAssignedCombiner() {
        java.security.TAccessControlContext acc;
        if (isPrivileged) {
     ...
     */
    java.security.TAccessControlContext optimize() {
        // the assigned (privileged or inherited) context
        java.security.TAccessControlContext acc;
        DomainCombiner combiner = null;
        java.security.TAccessControlContext parent = null;
     ...
     */
    private void calculateFields(java.security.TAccessControlContext assigned,
            java.security.TAccessControlContext parent, Permission[] permissions)
    {
    ...
    public boolean equals(Object obj) {
        ...
        if (! (obj instanceof java.security.TAccessControlContext))
            return false;

        java.security.AccessControlContext that = (java.security.TAccessControlContext) obj;
     ...
     */
    private boolean equalContext(java.security.TAccessControlContext that) {
     ...
     * scope is in effect.
     */
    private boolean equalLimitedContext(java.security.TAccessControlContext that) {
        if (that == null)
            return false;
         ...
         */
        java.security.AccessControlContext thisNextPC = getNextPC(this);
        java.security.AccessControlContext thatNextPC = getNextPC(that);
     ...
     */
    private static java.security.AccessControlContext getNextPC(java.security.AccessControlContext acc) {
    ...
    private boolean containsAllLimits(java.security.AccessControlContext that) {
        boolean match = false;
        Permission thisPerm;
