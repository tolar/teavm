...
public class TCertificateNotYetValidException extends TCertificateException {
     ...
     * exception.
     */
    public TCertificateNotYetValidException() {
        super();
    }
     ...
     */
    public TCertificateNotYetValidException(TString message) {
        super(message);
    }
}
