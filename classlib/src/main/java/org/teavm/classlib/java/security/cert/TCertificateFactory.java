...
public class TCertificateFactory {
    ...
    public final Collection<? extends TCertificate> generateCertificates
    (TInputStream inStream) throws CertificateException {
     ...
     */
    public final TCRL generateCRL(TInputStream inStream)
