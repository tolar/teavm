...
public class TX509CRLSelector implements TCRLSelector {
    ...
    private TX509Certificate certChecking;
    private long skew = 0;
     ...
     * @since 1.5
     */
    public void setIssuers(Collection<TX500Principal> issuers) {
     ...
     * @throws IOException if a parsing error occurs
     */
    private void addIssuerNameInternal(Object name, TX500Principal principal) {
        if (issuerNames == null) {
            issuerNames = new HashSet<Object>();
        }
     ...
     * @throws IOException if a parsing error occurs
     */
    private static HashSet<TX500Principal> parseIssuerNames(Collection<Object> names)
            throws IOException {
        HashSet<TX500Principal> x500Principals = new HashSet<TX500Principal>();
        for (Iterator<Object> t = names.iterator(); t.hasNext(); ) {
            Object nameObject = t.next();
            if (nameObject instanceof String) {
                x500Principals.add(new TX500Name((TString)nameObject).asX500Principal());
            } else {
                try {
                    x500Principals.add(new TX500Principal((byte[])nameObject));
     ...
     */
    void setDateAndTime(TDate dateAndTime, long skew) {
        this.dateAndTime =
     ...
     */
    public void setCertificateChecking(TX509Certificate cert) {
        certChecking = cert;
    }
     ...
     * @since 1.5
     */
    public Collection<TX500Principal> getIssuers() {
        if (issuerX500Principals == null) {
            return null;
        }
     ...
     */
    public TX509Certificate getCertificateChecking() {
        return certChecking;
    }
     ...
     */
    public boolean match(TCRL crl) {
        if (!(crl instanceof TX509CRL)) {
            return false;
        }
        TX509CRL xcrl = (TX509CRL)crl;

        /* match on issuer name */
        if (issuerNames != null) {
            TX500Principal issuer = xcrl.getIssuerX500Principal();
            Iterator<TX500Principal> i = issuerX500Principals.iterator();
            boolean found = false;
        ...
        if ((minCRL != null) || (maxCRL != null)) {
            ...
            byte[] crlNumExtVal = xcrl.getExtensionValue(TString.wrap("2.5.29.20"));
            if (crlNumExtVal == null) {
            }
            BigInteger crlNum;
            try {
                TDerInputStream in = new TDerInputStream(crlNumExtVal);
                byte[] encoded = in.getOctetString();
                TCRLNumberExtension crlNumExt =
                        new TCRLNumberExtension(Boolean.FALSE, encoded);
                crlNum = crlNumExt.get(TCRLNumberExtension.NUMBER);
    ...
    public Object clone() {
        try {
            TX509CRLSelector copy = (TX509CRLSelector)super.clone();
            if (issuerNames != null) {
                copy.issuerNames =
