...
abstract class TFileSystem {
     ...
     */
    public abstract String resolve(TFile f);

    public abstract String canonicalize(String path) throws TIOException;
     ...
     */
    public abstract int getBooleanAttributes(TFile f);
