 ...
 */
public abstract class TKeyStoreSpi {
    ...
    public void engineLoad(KeyStore.LoadStoreParameter param)
        ...
        if (param instanceof TKeyStore.SimpleLoadStoreParameter) {
            ...
            if (protection instanceof KeyStore.PasswordProtection) {
                ...
                CallbackHandler handler =
                        ((KeyStore.CallbackHandlerProtection)protection).getCallbackHandler();
